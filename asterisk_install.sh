...
if [ ! -f "/home/pi/asterisk-20-current.tar.gz" ];
then
echo "Download asterisk-20-current.tar.gz"
wget -P /home/pi http://downloads.asterisk.org/pub/telephony/asterisk/asterisk-20-current.tar.gz
fi

# Unzip file
sudo rm -rf /home/pi/asterisk-20-current
mkdir /home/pi/asterisk-20-current
tar -xvf /home/pi/asterisk-20-current.tar.gz -C /home/pi/asterisk-20-current --strip-components=1

echo "Install asterisk..."
cd /home/pi/asterisk-20-current && sudo contrib/scripts/install_prereq install
cd /home/pi/asterisk-20-current && sudo ./configure --with-pjproject-bundled
cd /home/pi/asterisk-20-current && sudo make menuselect
cd /home/pi/asterisk-20-current && sudo make
cd /home/pi/asterisk-20-current && sudo make install
echo "Configure Asterisk..."
cd /home/pi/asterisk-20-current && sudo make samples
cd /home/pi/asterisk-20-current && sudo make config
...
cat /home/pi/asterisk-20-current/include/asterisk/buildopts.h
